...
//            check col +
            if (boardPlace.getCol() + 1 < size && board[boardPlace.getRow()][boardPlace.getCol() + 1] != 0 
            		&& board[boardPlace.getRow()][boardPlace.getCol() + 1] != abstractPlayer.getBoardMark()) {//check right
